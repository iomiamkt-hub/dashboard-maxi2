  ...
  const etapas: Etapa[] = [
    {
      ...
      headerBg: 'bg-violet-700', accentText: 'text-violet-800',
      cardBg: 'bg-violet-50', cardBorder: 'border-violet-300', barColor: 'bg-violet-600',
    ...
    },
    {
      ...
      headerBg: 'bg-blue-700', accentText: 'text-blue-800',
      cardBg: 'bg-blue-50', cardBorder: 'border-blue-300', barColor: 'bg-blue-600',
    ...
    },
    {
      ...
      headerBg: 'bg-teal-700', accentText: 'text-teal-800',
      cardBg: 'bg-teal-50', cardBorder: 'border-teal-300', barColor: 'bg-teal-600',
      icone: <Calendar className="w-4 h-4" />, meta: META_CONSULTAS,
    },
    {
      numero: 4, nome: 'Orçamentos', valor: v.numero_orcamentos,
      headerBg: 'bg-amber-600', accentText: 'text-amber-800',
      cardBg: 'bg-amber-50', cardBorder: 'border-amber-300', barColor: 'bg-amber-600',
      icone: <FileText className="w-4 h-4" />, meta: META_CONSULTAS,
    },
    {
      numero: 5, nome: 'Contratos Fechados', valor: v.total_contratos,
      headerBg: 'bg-emerald-700', accentText: 'text-emerald-800',
      cardBg: 'bg-emerald-50', cardBorder: 'border-emerald-300', barColor: 'bg-emerald-600',
    ...
    },
    {
      ...
      headerBg: 'bg-green-800', accentText: 'text-green-800',
      cardBg: 'bg-green-50', cardBorder: 'border-green-300', barColor: 'bg-green-700',
